...
const { compile, planRetrieval, buildContinuityCarrier } = require('./index');
...
const continuity = buildContinuityCarrier({
  ...
  evidenceRefs: [{ id: 'result', ref: 'results/RESULT.md', hash, kind: 'result' }],
...
console.log(JSON.stringify({
  ...
  retrievalQuality: { discoveryBodyCount: retrieval.discovery.bodyCount, selectedId: retrieval.selectedId, nextAction: retrieval.next.action },
