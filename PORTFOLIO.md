...
| --- | --- | --- | --- |
| Context & Continuity | bounded context packaging, source-aware resume, provider-neutral continuity patterns | foundation/runbook available; software packaging in progress | deep personal continuity, proprietary retrieval/routing/adaptation |
...
Release is gated on a separate software license decision, clean-consumer packaging and public QA.
...
The public package will not imply formal proof, universal production readiness or zero defects.

## Evidence archive relationship

`pai-reliability-evidence` remains a public evidence source during migration. PAI will progressively curate reusable pieces into this repository while preserving source provenance and historical failure/supersession truth.

The archive should only be retired or redirected after its useful material is mapped and public links remain intact or have explicit successors.
